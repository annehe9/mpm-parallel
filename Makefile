...
OBJS = $(OBJDIR)/main.o $(OBJDIR)/CMU418intrin.o
...
$(OBJDIR)/CMU418intrin.o: $(SRCDIR)/CMU418intrin.cpp $(SRCDIR)/CMU418intrin.h
	mkdir -p $(OBJDIR)
	$(CC) $(CFLAGS) -c $(SRCDIR)/CMU418intrin.cpp -o $(OBJDIR)/CMU418intrin.o
